            ...
            <ul class="module-create-options">
                ...
                <accordion-group is-open="true">
                        ...
                        <ul class="module-create-options">
                            ...
                            <li data-ng-show="settings.notification_buttons_status == 'block'">
                                <span class="module-create-title">View Cart Background Color</span>
                                <span class="module-create-option">
                            ...
                            <li data-ng-show="settings.notification_buttons_status == 'block'">
                                <span class="module-create-title">View Cart Background Hover</span>
                                <span class="module-create-option">
                            ...
                            <li data-ng-show="settings.notification_buttons_status == 'block'">
                                <span class="module-create-title">Checkout Background Hover</span>
                                <span class="module-create-option">
