...
<div class="module-body module-form">
    ...
    <accordion close-others="module_data.close_others">
        ...
        <accordion-group data-ng-repeat="column in module_data.columns" is-open="column.is_open">
            <accordion-heading>
                <div class="accordion-bar bar-level-1"> {{'Column ' + ($index + 1)}} - {{column.width}} % <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeColumn($index)"><b></b>Remove</a></div>
            </accordion-heading>
            <ul class="module-create-options">
                <li>
            ...
            <accordion close-others="column.close_others">
                <accordion-group data-ng-repeat="module in column.modules" is-open="module.is_open">
                    <accordion-heading>
                        <div class="accordion-bar bar-level-2">Module {{$index + 1}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeModule(column, $index)"><b></b>Remove</a></div>
                    </accordion-heading>
                    <ul class="module-create-options">
                        <li>
