...
<div class="module-body module-form">
    ...
    <accordion close-others="module_data.close_others">
        ...
        <accordion-group data-ng-repeat="section in module_data.sections" is-open="section.is_open">
            <accordion-heading>
                <div class="accordion-bar bar-level-1"> {{section.name || ('Item ' + ($index + 1))}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeSection($index)"><b ></b>Remove</a></div>
            </accordion-heading>
            <ul class="module-create-options">
                <li>
                ...
                <li>
                    <span class="module-create-title">Headline Text</span>
                    <span class="module-create-option">
