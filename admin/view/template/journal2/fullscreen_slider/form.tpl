...
<div class="module-body module-form fullscreen-slider">
    ...
    <accordion close-others="module_data.close_others">
        ...
        <accordion-group data-ng-repeat="image in module_data.images" is-open="image.is_open">
            <accordion-heading>
                <div class="accordion-bar bar-level-1"> Image {{$index + 1}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeImage($index)"><b ></b>Remove</a></div>
            </accordion-heading>
            <ul class="module-create-options">
                <li>
