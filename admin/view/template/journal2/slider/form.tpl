...
<div class="module-body module-form">
    ...
    <accordion close-others="module_data.close_others">
        ...
        <accordion-group data-ng-repeat="slide in module_data.slides" is-open="slide.is_open">
            <accordion-heading>
                <div class="accordion-bar bar-level-1">{{slide.slide_name || ('Slide ' + ($index + 1))}} <a class="accordion-remove slide-remove" data-ng-click="removeSlide($index)"><b ></b>Remove</a></div>
            </accordion-heading>
            ...
            <accordion close-others="slide.close_others">
                <accordion-group data-ng-repeat="caption in slide.captions" is-open="caption.is_open">
                    <accordion-heading>
                        <div class="accordion-bar bar-level-2">{{caption.caption_name || ('Caption ' + ($index + 1))}} <a class="accordion-remove slide-remove" data-ng-click="removeCaption(slide, $index)"><b ></b>Remove</a></div>
                    </accordion-heading>
                    <div class="accordion-content content-level-2">
                        <ul class="module-create-options">
                            ...
                            <li data-ng-show="caption.multilanguage_position == '0'">
                                <span class="module-create-title">Position X</span>
                                <span class="module-create-option">
                                    <input type="text" class="journal-input journal-number-field" data-ng-model="caption.x" />
                                </span>
                            </li>
							<li data-ng-show="caption.multilanguage_position == '0'">
                                <span class="module-create-title">Position Y</span>
                                <span class="module-create-option">
