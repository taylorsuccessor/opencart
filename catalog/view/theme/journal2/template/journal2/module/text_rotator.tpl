...
<?php endif; ?>
<div class="journal-rotator box text-rotator <?php echo implode(' ', $disable_on_classes); ?> bullets-<?php echo $bullets_position; ?> align-<?php echo $text_align; ?> bullets-<?php echo $bullets ? 'on' : 'off'; ?>" id="journal-rotator-<?php echo $module; ?>" style="<?php echo $rotator_css; ?>; <?php echo isset($css) ? $css : ''; ?>">
