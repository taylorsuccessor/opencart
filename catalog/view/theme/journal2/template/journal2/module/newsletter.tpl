<div class="box journal-newsletter text-<?php echo $text_class; ?> <?php echo implode(' ', $disable_on_classes); ?>" id="journal-newsletter-<?php echo $module; ?>" style="<?php echo isset($css) ? $css : ''; ?>">
