<?php
class ControllerModuleJournal2BlogSearch extends Controller {
    ...
    public function __construct($registry) {
        ...
        if (self::$CACHEABLE === null) {
            self::$CACHEABLE = (bool)$this->journal2->settings->get('config_system_settings.blog_search_cache');
        }
    }
    ...
    public function index($setting) {
        ...
        if ($cache === null || self::$CACHEABLE !== true || $hash === null) {
            ...
            $this->template = 'journal2/module/blog_search.tpl';
